...
AVAILABLE_MODELS = {
    'English': 'https://alphacephei.com/vosk/models/vosk-model-en-us-0.22-lgraph.zip',
    'Chinese': 'https://alphacephei.com/vosk/models/vosk-model-cn-0.22.zip',
    'Dutch': 'https://alphacephei.com/vosk/models/vosk-model-nl-spraakherkenning-0.6.zip',
    'French': 'https://alphacephei.com/vosk/models/vosk-model-fr-0.22.zip',
    'German': 'https://alphacephei.com/vosk/models/vosk-model-de-0.21.zip',
    'Italian': 'https://alphacephei.com/vosk/models/vosk-model-it-0.22.zip',
    'Spanish': 'https://alphacephei.com/vosk/models/vosk-model-es-0.42.zip',
    'Russian': 'https://alphacephei.com/vosk/models/vosk-model-ru-0.22.zip',
    ...
    'Japanese': 'https://alphacephei.com/vosk/models/vosk-model-ja-0.22.zip',
