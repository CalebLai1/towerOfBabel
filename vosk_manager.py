...
AVAILABLE_MODELS = {
    ...
    'Indian English': 'https://alphacephei.com/vosk/models/vosk-model-small-en-in-0.4.zip',
    ...
    'Arabic': 'https://alphacephei.com/vosk/models/vosk-model-small-ar-tn-0.1-linto.zip',
    ...
    'Tajik': 'https://alphacephei.com/vosk/models/vosk-model-small-tg-0.22.zip',
